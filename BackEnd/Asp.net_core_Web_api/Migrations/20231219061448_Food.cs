    ...
    public partial class Food : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserOrderedFood", x => x.ID);
                    table.ForeignKey(
                        name: "FK_UserOrderedFood_Food_FoodID",
                        column: x => x.FoodID,
                        principalTable: "Food",
                        principalColumn: "FoodID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserOrderedFood_User_UserID",
                        column: x => x.UserID,
                        principalTable: "User",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserOrderedFood_FoodID",
                table: "UserOrderedFood",
                column: "FoodID");

            migrationBuilder.CreateIndex(
                name: "IX_UserOrderedFood_UserID",
                table: "UserOrderedFood",
                column: "UserID");
        }
